Shader "NatureManufacture Shaders/Water River Tesseled"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 panner598 = ( uv_SmallCascadeNormal + mulTime427 * (( (float)Direction723 == 1 ) ? _SmallCascadeMainSpeed :  appendResult710 ));
			...
			float lerpResult407 = lerp( ( ( _WaterTessScale * tex2Dlod( _WaterTesselation, half4( WaterSpeedValueMix516, 0, 1) ).r ) + ( _WaterTessScale * tex2Dlod( _WaterTesselation, half4( WaterSpeedValueMain614, 0, 1) ).r ) ) , ( ( ( tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeSpeedValueMix433, 0, 1) ).r * _SmallCascadeWaterTessScale ) + ( tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeSpeedValueMain600, 0, 0) ).r * _SmallCascadeWaterTessScale ) ) * clampResult285 ) , clampResult285);
			...
			float2 panner607 = ( uv_BigCascadeNormal + mulTime519 * (( (float)Direction723 == 1 ) ? _BigCascadeMainSpeed :  appendResult714 ));
			float2 BigCascadeSpeedValueMain432 = panner607;
			float lerpResult568 = lerp( lerpResult407 , ( ( ( _BigCascadeWaterTessScale * tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeSpeedValueMix608, 0, 1) ).r ) + ( _BigCascadeWaterTessScale * tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeSpeedValueMain432, 0, 1) ).r ) ) * clampResult514 ) , clampResult514);
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float lerpResult786 = lerp( pow( ( temp_output_89_0 + _ShalowDepth ) , _ShalowFalloff ) , 100 , ( _BigCascadeTransparency * clampResult514 ));
			...
			float clampResult488 = clamp( ( pow( min( tex2DNode647.r , tex2D( _Noise, panner321 ).r ) , _SmallCascadeNoisePower ) * 20 ) , 0 , 1 );
			float lerpResult480 = lerp( 0 , tex2DNode319.g , clampResult488);
			float clampResult322 = clamp( pow( tex2DNode319.g , _SmallCascadeFoamFalloff ) , 0 , 1 );
			...
			float clampResult783 = clamp( ( pow( min( tex2DNode647.r , tex2D( _Noise, ( panner321 + float2( -0.47,0.37 ) ) ).r ) , _BigCascadeNoisePower ) * 20 ) , 0 , 1 );
			float lerpResult626 = lerp( ( tex2DNode213.r * 0.5 ) , tex2DNode213.r , clampResult783);
			float clampResult299 = clamp( pow( tex2DNode213.r , _BigCascadeFoamFalloff ) , 0 , 1 );
