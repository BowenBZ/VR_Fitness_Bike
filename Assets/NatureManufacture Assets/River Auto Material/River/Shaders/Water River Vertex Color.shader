Shader "NatureManufacture Shaders/Water River Vertex Color"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float clampResult803 = clamp( ( pow( min( tex2DNode647.r , tex2D( _Noise, ( panner321 + float2( -0.47,0.37 ) ) ).r ) , _BigCascadeNoisePower ) * 20.0 ) , 0.0 , 1.0 );
			float lerpResult626 = lerp( ( tex2DNode213.r * 0.5 ) , tex2DNode213.r , clampResult803);
