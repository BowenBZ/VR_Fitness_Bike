Shader "NatureManufacture Shaders/Water River Tesseled Vertex Color Flow"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float temp_output_834_0 = abs( ( ( temp_output_818_0 + -0.5 ) * 2 ) );
			...
			float temp_output_415_0 = ( ( _WaterTessScale * tex2Dlod( _WaterTesselation, half4( WaterSpeedValueMix516, 0, 1) ).r ) + ( _WaterTessScale * lerpResult840 ) );
			...
			float mulTime989 = _Time.y * 1;
			float temp_output_990_0 = ( mulTime989 * 0.25 );
			float temp_output_987_0 = frac( ( temp_output_990_0 + 1 ) );
			float2 SmallCascadeWaterSpeedValueMainFlowUV1860 = ( uv_SmallCascadeNormal + ( appendResult849 * temp_output_987_0 ) );
			float2 SmallCascadeWaterSpeedValueMainFlowUV2854 = ( uv_SmallCascadeNormal + ( appendResult849 * frac( ( temp_output_990_0 + 0.5 ) ) ) );
			float temp_output_857_0 = abs( ( ( temp_output_987_0 + -0.5 ) * 2 ) );
			float SmallCascadeSlowFlowHeightBase859 = temp_output_857_0;
			float lerpResult869 = lerp( tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeWaterSpeedValueMainFlowUV1860, 0, 1) ).r , tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeWaterSpeedValueMainFlowUV2854, 0, 0) ).r , SmallCascadeSlowFlowHeightBase859);
			float temp_output_414_0 = ( ( tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeSpeedValueMix433, 0, 1) ).r * _SmallCascadeWaterTessScale ) + ( lerpResult869 * _SmallCascadeWaterTessScale ) );
			...
			float mulTime979 = _Time.y * 1;
			float temp_output_980_0 = ( mulTime979 * 0.6 );
			float temp_output_984_0 = frac( ( temp_output_980_0 + 1 ) );
			float2 BigCascadeWaterSpeedValueMainFlowUV1893 = ( uv_BigCascadeNormal + ( appendResult884 * temp_output_984_0 ) );
			float2 BigCascadeWaterSpeedValueMainFlowUV2894 = ( uv_BigCascadeNormal + ( appendResult884 * frac( ( temp_output_980_0 + 0.5 ) ) ) );
			float BigCascadeSlowFlowHeightBase895 = abs( ( ( temp_output_984_0 + -0.5 ) * 2 ) );
			float lerpResult874 = lerp( tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeWaterSpeedValueMainFlowUV1893, 0, 1) ).r , tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeWaterSpeedValueMainFlowUV2894, 0, 1) ).r , BigCascadeSlowFlowHeightBase895);
			float temp_output_565_0 = ( ( _BigCascadeWaterTessScale * tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeSpeedValueMix608, 0, 1) ).r ) + ( _BigCascadeWaterTessScale * lerpResult874 ) );
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult925 = (half2(( (( (float)Direction723 == 1 ) ? _FoamSpeed :  appendResult919 ).x * uv4_TexCoord829.x ) , ( (( (float)Direction723 == 1 ) ? _FoamSpeed :  appendResult919 ).y * uv4_TexCoord829.y )));
			float2 temp_output_931_0 = ( uv_Foam + ( appendResult925 * temp_output_818_0 ) );
			float2 FoamCascadeWaterSpeedValueMainFlowUV1932 = temp_output_931_0;
			float2 temp_output_929_0 = ( uv_Foam + ( appendResult925 * temp_output_820_0 ) );
			float2 FoamCascadeWaterSpeedValueMainFlowUV2933 = temp_output_929_0;
			float temp_output_930_0 = abs( ( ( temp_output_818_0 + -0.5 ) * 2 ) );
			float FoamCascadeSlowFlowHeightBase935 = temp_output_930_0;
			float lerpResult937 = lerp( tex2D( _Foam, FoamCascadeWaterSpeedValueMainFlowUV1932 ).r , tex2D( _Foam, FoamCascadeWaterSpeedValueMainFlowUV2933 ).r , FoamCascadeSlowFlowHeightBase935);
