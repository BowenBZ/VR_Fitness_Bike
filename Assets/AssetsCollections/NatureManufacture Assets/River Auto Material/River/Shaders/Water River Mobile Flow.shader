Shader "NatureManufacture Shaders/Mobile Water River Flow"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 uv4_TexCoord816 = i.uv4_texcoord4 * float2( 1,1 ) + float2( 0,0 );
			float2 appendResult769 = (half2(( (( (float)Direction723 == 1 ) ? _WaterMainSpeed :  appendResult705 ).x * uv4_TexCoord816.x ) , ( (( (float)Direction723 == 1 ) ? _WaterMainSpeed :  appendResult705 ).y * uv4_TexCoord816.y )));
			float mulTime815 = _Time.y * 1;
			float temp_output_814_0 = ( mulTime815 * 1 );
			float temp_output_811_0 = frac( ( temp_output_814_0 + 1 ) );
			float2 WaterSpeedValueMainFlowUV1777 = ( uv_WaterNormal + ( appendResult769 * temp_output_811_0 ) );
			float temp_output_810_0 = frac( ( temp_output_814_0 + 0.5 ) );
			float2 WaterSpeedValueMainFlowUV2776 = ( uv_WaterNormal + ( appendResult769 * temp_output_810_0 ) );
			float clampResult778 = clamp( abs( ( ( temp_output_811_0 + -0.5 ) * 2 ) ) , 0 , 1 );
			...
			float2 appendResult791 = (half2(( (( (float)Direction723 == 1 ) ? _SmallCascadeMainSpeed :  appendResult710 ).x * uv4_TexCoord816.x ) , ( (( (float)Direction723 == 1 ) ? _SmallCascadeMainSpeed :  appendResult710 ).y * uv4_TexCoord816.y )));
			float mulTime887 = _Time.y * 1;
			float temp_output_888_0 = ( mulTime887 * 0.25 );
			float temp_output_892_0 = frac( ( temp_output_888_0 + 1 ) );
			float2 SmallCascadeWaterSpeedValueMainFlowUV1782 = ( uv_WaterNormal + ( appendResult791 * temp_output_892_0 ) );
			float2 SmallCascadeWaterSpeedValueMainFlowUV2781 = ( uv_WaterNormal + ( appendResult791 * frac( ( temp_output_888_0 + 0.5 ) ) ) );
			float SmallCascadeSlowFlowHeightBase780 = abs( ( ( temp_output_892_0 + -0.5 ) * 2 ) );
			...
			float2 appendResult809 = (half2(( (( (float)Direction723 == 1 ) ? _BigCascadeMainSpeed :  appendResult714 ).x * uv4_TexCoord816.x ) , ( (( (float)Direction723 == 1 ) ? _BigCascadeMainSpeed :  appendResult714 ).y * uv4_TexCoord816.y )));
			float mulTime898 = _Time.y * 1;
			float temp_output_897_0 = ( mulTime898 * 0.6 );
			float temp_output_894_0 = frac( ( temp_output_897_0 + 1 ) );
			float2 BigCascadeWaterSpeedValueMainFlowUV1797 = ( uv_WaterNormal + ( appendResult809 * temp_output_894_0 ) );
			float2 BigCascadeWaterSpeedValueMainFlowUV2796 = ( uv_WaterNormal + ( appendResult809 * frac( ( temp_output_897_0 + 0.5 ) ) ) );
			float clampResult798 = clamp( abs( ( ( temp_output_894_0 + -0.5 ) * 2 ) ) , 0 , 1 );
			...
			float2 appendResult876 = (half2(( (( (float)Direction723 == 1 ) ? _FoamSpeed :  appendResult886 ).x * uv4_TexCoord816.x ) , ( (( (float)Direction723 == 1 ) ? _FoamSpeed :  appendResult886 ).y * uv4_TexCoord816.y )));
			float2 FoamCascadeWaterSpeedValueMainFlowUV1871 = ( uv_Foam + ( appendResult876 * temp_output_811_0 ) );
			float2 FoamCascadeWaterSpeedValueMainFlowUV2882 = ( uv_Foam + ( appendResult876 * temp_output_810_0 ) );
			float clampResult881 = clamp( abs( ( ( temp_output_811_0 + -0.5 ) * 2 ) ) , 0 , 1 );
			float FoamCascadeSlowFlowHeightBase883 = clampResult881;
			float lerpResult850 = lerp( tex2D( _Foam, FoamCascadeWaterSpeedValueMainFlowUV1871 ).r , tex2D( _Foam, FoamCascadeWaterSpeedValueMainFlowUV2882 ).r , FoamCascadeSlowFlowHeightBase883);
			...
			float2 temp_output_900_0 = ( _NoiseTiling * uv_CascadesTextures );
			float2 panner646 = ( temp_output_900_0 + _SinTime.x * ( temp_output_743_0 * float2( -1.2,-0.9 ) ));
			half4 tex2DNode647 = tex2D( _CascadesTextures, panner646 );
			float2 panner321 = ( temp_output_900_0 + _SinTime.x * temp_output_743_0);
			float clampResult488 = clamp( ( pow( min( tex2DNode647.a , tex2D( _CascadesTextures, panner321 ).a ) , _SmallCascadeNoisePower ) * 20 ) , 0 , 1 );
			float lerpResult480 = lerp( 0 , lerpResult835 , clampResult488);
			float clampResult322 = clamp( pow( lerpResult835 , _SmallCascadeFoamFalloff ) , 0 , 1 );
			...
			float clampResult299 = clamp( pow( lerpResult840 , _BigCascadeFoamFalloff ) , 0 , 1 );
			...
			half3 temp_cast_20 = (lerpResult587).xxx;
			o.Specular = temp_cast_20;
