 Shader "NatureManufacture Shaders/Water Swamp Vertex Color Flow"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float smoothstepResult1056 = smoothstep( 0 , 0.2 , pow( max( lerpResult1016 , lerpResult1014 ) , _Detail2NoisePower ));
			float clampResult962 = clamp( ( 1.0 - smoothstepResult1056 ) , 0 , 1 );
			...
			float lerpResult1078 = lerp( ( i.vertexColor.a * lerpResult1076 ) , temp_output_779_0 , clampResult285);
