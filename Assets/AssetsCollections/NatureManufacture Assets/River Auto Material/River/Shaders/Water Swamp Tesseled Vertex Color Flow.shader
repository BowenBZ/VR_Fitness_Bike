Shader "NatureManufacture Shaders/Water Swamp Tesseled Vertex Color Flow"
{
	Properties
	{
		...
		_Detail2Normal("Detail 2 Normal", 2D) = "bump" {}
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 Detail2SpeedValueMainFlowUV11022 = ( uv_Detail2Albedo + temp_output_826_0 );
			float2 Detail2SpeedValueMainFlowUV21025 = ( uv_Detail2Albedo + temp_output_825_0 );
			...
			float smoothstepResult1056 = smoothstep( 0 , 0.47 , pow( max( lerpResult1016 , lerpResult1014 ) , _Detail2NoisePower ));
			float clampResult962 = clamp( smoothstepResult1056 , 0 , 1 );
			...
			float temp_output_1036_0 = ( clampResult962 * lerpResult947.a );
			float3 lerpResult933 = lerp( lerpResult932 , lerpResult922 , temp_output_1036_0);
			float3 lerpResult748 = lerp( lerpResult933 , lerpResult864 , ( i.vertexColor / float4( 1,1,1,1 ) ).r);
			float3 lerpResult749 = lerp( lerpResult748 , lerpResult922 , ( i.vertexColor / float4( 1,1,1,1 ) ).g);
			float3 lerpResult750 = lerp( lerpResult749 , temp_output_24_0 , ( i.vertexColor / float4( 1,1,1,1 ) ).b);
			...
			float4 lerpResult987 = lerp( lerpResult964 , temp_output_1108_0 , temp_output_1036_0);
			float4 lerpResult986 = lerp( lerpResult987 , temp_output_1106_0 , ( i.vertexColor / float4( 1,1,1,1 ) ).r);
			float4 lerpResult984 = lerp( lerpResult986 , temp_output_1108_0 , ( i.vertexColor / float4( 1,1,1,1 ) ).g);
			float4 lerpResult1113 = lerp( lerpResult984 , lerpResult773 , ( i.vertexColor / float4( 1,1,1,1 ) ).b);
			...
			float4 lerpResult970 = lerp( lerpResult969 , temp_output_1052_0 , temp_output_1036_0);
			float4 lerpResult130 = lerp( lerpResult970 , temp_output_1051_0 , ( i.vertexColor / float4( 1,1,1,1 ) ).r);
			float4 lerpResult785 = lerp( lerpResult130 , temp_output_1052_0 , ( i.vertexColor / float4( 1,1,1,1 ) ).g);
			half4 temp_cast_7 = (_WaterSpecular).xxxx;
			float4 lerpResult786 = lerp( lerpResult785 , temp_cast_7 , ( i.vertexColor / float4( 1,1,1,1 ) ).b);
			...
			float4 lerpResult1102 = lerp( tex2D( _Detail1R_Sm_Detail_2_A_Sm, Detail2SpeedValueMainFlowUV11022 ) , tex2D( _Detail1R_Sm_Detail_2_A_Sm, Detail2SpeedValueMainFlowUV21025 ) , SlowFlowHeightBase835);
			float temp_output_1094_0 = ( lerpResult1102.a * _Detail2Smoothness );
			float lerpResult974 = lerp( lerpResult973 , temp_output_1094_0 , temp_output_1036_0);
			float lerpResult975 = lerp( lerpResult974 , temp_output_1093_0 , ( i.vertexColor / float4( 1,1,1,1 ) ).r);
			float lerpResult972 = lerp( lerpResult975 , temp_output_1094_0 , ( i.vertexColor / float4( 1,1,1,1 ) ).g);
			float lerpResult971 = lerp( lerpResult972 , _WaterSmoothness , ( i.vertexColor / float4( 1,1,1,1 ) ).b);
			...
			float lerpResult1039 = lerp( lerpResult1038 , _Detail2AOPower , temp_output_1036_0);
			float lerpResult1040 = lerp( lerpResult1039 , _DetailAOPower , ( i.vertexColor / float4( 1,1,1,1 ) ).r);
			float lerpResult1041 = lerp( lerpResult1040 , _Detail2AOPower , ( i.vertexColor / float4( 1,1,1,1 ) ).g);
			float lerpResult1042 = lerp( lerpResult1041 , _WaterAOPower , ( i.vertexColor / float4( 1,1,1,1 ) ).b);
			...
			float lerpResult1076 = lerp( lerpResult1075 , 1 , temp_output_1036_0);
			float lerpResult1078 = lerp( ( lerpResult1076 * i.vertexColor.a ) , temp_output_779_0 , clampResult285);
